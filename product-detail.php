        ...
        else
        {
        		...
        		if(mysqli_num_rows($result) == 0) {
        		     ...
        		     // echo $userid;
        			  ...
        			  $query = "insert into cart(orderid, prodID, prodCat, qty) values('191', '$prodID', '$prodCat', '$qty')";
								...
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
									<div class="p-b-30 m-lr-15-sm">
										...
										<form class="w-full"  id="reviewform"  method="POST">
                                            ...
                                            if(isset($_POST['userid']) && isset($_POST['prodID'])&& isset($_POST['prodCat'])&& isset($_POST['prodCatName'])&& isset($_POST['review'])&& isset($_POST['rating'])){
											$userid = $_POST['userid'];
											$prodId = $_POST['prodID'];
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Any questions? Let us know in store at Marketplace, 101 San Fernando, San Jose, CA-95112 or call us on (+1) 96 716 6879
					</p>
